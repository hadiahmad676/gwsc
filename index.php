...
<!--Slider Start-->
     <div id="slider">
        <figure>
            <img src="images/camping1.jpg" alt="Camping Site">
            <img src="images/camping2.png" alt="Wild Swimming">
            <img src="images/camping3.jpg" alt="Wild Swimmin">
            <img src="images/camping2.png" alt="Wild Swimmin">
            <img src="images/camping1.jpg" alt="Camping Site">
        </figure>
    </div>
     <!--Slider Ends-->
     ...
     <div class="hcard">
        <div class="text1">
            <h1><span>A little</span> about us</h1>
            <p>
               We offer the most premium wild camping and swimming experiences for over 15 years!
               With us, you will get to experience the natural beauties of the world. We welcome anyone to be
               part of our community.
        </div>
           <img src="images/about.jpg" alt="Camping Site">
            </p>
    </div>
     <!--Horizontal Card End-->
    ...
    <div class="contact-me">
        <p>The best <span>Wild Swimming </span>and <span>Wild Camping </span>experience you will have</p>
    </div>
    <!--Middle Section End-->
    ...
    <hr>
     ...
     <!--3 Card Start-->
        <section class="cards-container">
            <div class="card">
                <div><img src="images/card4.jpg" class="card-image" alt="Camping at Aburi"></div>
                    <h2>Aburi</h2>
                    <p>This is a popular spot for most tourists as it is closest to the city.
                      Everyone is friendly and ready to speak to you.
                    </p>
                    <a href="#">READ MORE</a>
            </div>

            <div class="card">
                <div><img src="images/card2.jpg" class="card-image" alt="Camping at Ho"></div>
                    <h2>Ho</h2>
                    <p>Ho is a place for the adventerous. You may hike for 2 hours in order to get to good 
                      wild camping.
                    </p>
                    <a href="#">READ MORE</a>
            </div>
            ...
            <div class="card">
                <div><img src="images/card3.jpg" class="card-image" alt="Camping at Tagbo"></div>
                    <h2>Tagbo</h2>
                    <p>A magical place to find a twin waterfall. Danger free wildlife is all around.
                    </p>
                    <a href="#">READ MORE</a>
            </div>
        </section>
